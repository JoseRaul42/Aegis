...
namespace Aegis.EmbeddingsAgent
{
    internal class EmbeddingsAgent
    {
        ...
        public static async Task<string> GetChatResponse(string userInput, string agentName)
        {
            try
            {
                ...
                //TODO: THIS NEEDS TO BE CHANGED SINCE THE FILE STRUCTURE IS CALLED FROM THE BIN FOLDER WHEN TESTING NOT THE SAME FILE STRUCTURE AS THE REPO NOT THE SAME FILE STRUCTURE AS THE REPO
